...
# Import v1 directly
import tsp_v1_nearest_neighbor_fixed
...
try:
    ...
    # Run algorithm
    tour, tour_length = tsp_v1_nearest_neighbor_fixed.tsp_v1_nearest_neighbor_fixed(
        points, distance_matrix=distance_matrix
    )
