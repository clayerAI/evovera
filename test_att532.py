...
def main():
    print("Testing v11 on att532...")
    
    parser = TSPLIBParser("data/tsplib/att532.tsp")
    if not parser.parse():
    ...
    print(f"att532: n={n}, matrix shape={distance_matrix.shape}")
