...
mst_adj_opt, _ = solver_opt._compute_mst()
solver_opt._build_lca_structure(mst_adj_opt)
edge_centrality_opt = solver_opt._compute_edge_centrality_optimized(mst_adj_opt)
...
print("\n=== MST COMPARISON ===")
print(f"Optimized MST edges: {len(mst_adj_opt)}")
