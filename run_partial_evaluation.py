...
# TSPLIB instances to evaluate (excluding att532 for now)
TSPLIB_INSTANCES = ["eil51", "kroA100", "a280"]
...
print("\n" + "=" * 80)
print("EVALUATION SUMMARY (Partial - without att532)")
print("=" * 80)
...
output_file = "tsplib_evaluation_partial_results.json"
