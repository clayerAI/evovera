#!/usr/bin/env python3
"""Run Phase 3 final evaluation with reasonable timeouts."""
...
TSPLIB_INSTANCES = {
    "eil51": {"file": "data/tsplib/eil51.tsp", "optimal": 426, "seeds": 10},
    "kroA100": {"file": "data/tsplib/kroA100.tsp", "optimal": 21282, "seeds": 10},
    "d198": {"file": "data/tsplib/d198.tsp", "optimal": 15780, "seeds": 10},
    "a280": {"file": "data/tsplib/a280.tsp", "optimal": 2579, "seeds": 5},
    "lin318": {"file": "data/tsplib/lin318.tsp", "optimal": 42029, "seeds": 5},
    "pr439": {"file": "data/tsplib/pr439.tsp", "optimal": 107217, "seeds": 5},
    "att532": {"file": "data/tsplib/att532.tsp", "optimal": 27686, "seeds": 5},
}

# Timeout settings (seconds)
TIMEOUT_V11 = 180  # Same as Phase 2
TIMEOUT_ORTOOLS = 60  # 60 seconds per instance for OR-Tools
...
for instance_name, instance_info in TSPLIB_INSTANCES.items():
    ...
    for seed in range(1, num_seeds + 1):
        ...
        if ortools_gap is not None and ortools_runtime <= TIMEOUT_ORTOOLS:
...
if all_v11_gaps and all_ortools_gaps:
    ...
    try:
        ...
        print(f"Overall statistical significance: p = {p_value:.6f} {'(significant)'        print(f"Overall runtime ratio: {overall_runtime_ratio:.2f}x (v11/OR-Tools)")
...
with open(summary_file, 'w') as f:
    ...
    f.write(f"- **Timeouts:** v11={TIMEOUT_V11}s, OR-Tools={TIMEOUT_ORTOOLS}s\n")
