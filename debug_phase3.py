...
v11_solver = ChristofidesHybridStructuralOptimizedV11()
v11_solver.set_distance_matrix(dist_matrix)
v11_tour, v11_cost = v11_solver.solve()
v11_gap = ((v11_cost - optimal) / optimal) * 100
print(f"  v11: cost={v11_cost}, gap={v11_gap:.2f}%")
